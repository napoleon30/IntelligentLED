...
public interface IDeviceDao {
	 ...
	 */
	List<Device> query(String whereClause, String[] whereArgs);
	...
	long update(long id,String name,String deviceID,String physicalDeviceID,int type,String group,int grouptype);
