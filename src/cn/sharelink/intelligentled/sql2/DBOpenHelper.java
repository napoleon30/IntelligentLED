...
public class DBOpenHelper extends SQLiteOpenHelper {
	...
	public void onCreate(SQLiteDatabase db) {
		...
		String sql = "CREATE TABLE " + Database.Student.TABLE_NAME + " ("
				...
				+ Database.Student.Columns.NAME + " VARCHAR(30), "
				+ Database.Student.Columns.DEVICEID + " VARCHAR(30),"
				+ Database.Student.Columns.PHYSICALDEVICEID + " VARCHAR(30),"
				+ Database.Student.Columns.TYPE + " INTEGER, "
				+ Database.Student.Columns.GROUP + " VARCHAR(30), " 
				+ Database.Student.Columns.GROUPTYPE + " INTEGER " 
				+ ")";
